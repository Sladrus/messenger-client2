...
const OrderFilterUser = observer(({ users, ordersStore }) => {
  const handleChange = (event) => {
    ordersStore.setFilterUser(event.target.value);
  };
    ...
    <Box sx={{ minWidth: "200px", color: "black", height: "45px" }}>
      ...
      >
        ...
        <Select
          ...
          value={ordersStore.filter.responsible}
...
export default OrderFilterUser;
