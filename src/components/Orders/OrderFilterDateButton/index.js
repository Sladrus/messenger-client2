...
const OrderFilterDateButton = observer(({ handleOpen, ordersStore }) => {
  const dateRange = ordersStore.filter.dateRange;
  ...
  const handleClear = () => {
    ordersStore.setFilterDateRange({
      startDate: null,
      endDate: new Date(
...
export default OrderFilterDateButton;
